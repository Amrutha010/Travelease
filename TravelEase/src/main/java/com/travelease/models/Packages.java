...
//	private Bus bus;
	...
	public String toString() {
		return "Packages [packageId=" + packageId + ", packageName=" + packageName + ", packageDescription="
				+ packageDescription + ", packageCost=" + packageCost + ", packageRating=" + packageRating + "]";
	}
	...
	public Packages(Integer packageId,
			...
			@Pattern(regexp = "^[A-Za-z]+ [A-Za-z]+$") String packageDescription, @Min(5000) Double packageCost,
